...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = function (_React$Component) {
	  ...
	  function Timer(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Timer).call(this, props));
	  }
	  ...
	  _createClass(Timer, [{
	    ...
	    value: function updateTimer() {
	      _stores.store.dispatch({ type: 'UPDATE' });
	    ...
	    value: function initTimer(restart) {
	      ...
	      _stores.store.dispatch({ type: 'RESET' });
	      this.startTimer();
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var _store$getState$timer = _stores.store.getState().timer;

	      var minutes = _store$getState$timer.minutes;
	      var seconds = _store$getState$timer.seconds;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var timer = exports.timer = function timer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? { minutes: 0, seconds: 0 } : arguments[0];
