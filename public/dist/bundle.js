...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = function (_React$Component) {
	  ...
	  function Timer(props) {
	    ...
	    _this.state = { minutes: 0, seconds: 0 };
	    return _this;
	  }
	...
	var Pomodoro = function (_React$Component2) {
	  _inherits(Pomodoro, _React$Component2);

	  function Pomodoro(props) {
	    _classCallCheck(this, Pomodoro);

	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Pomodoro).call(this, props));

	    _this2.state = { start: false };
	    return _this2;
	  }
